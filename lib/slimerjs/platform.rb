  ...
  class Platform
    ...
    class Lightweight < Platform
      class << self
        ...
        def package_url
          'http://download.slimerjs.org/v0.9/0.9.4/slimerjs-0.9.4.zip'
        end
      end
    end
    ...
    class Linux64 < Platform
      class << self
        ...
        def package_url
          'http://download.slimerjs.org/releases/0.9.4/slimerjs-0.9.4-linux-x86_64.tar.bz2'
        end
      end
    end
    ...
    class Linux32 < Platform
      class << self
        ...
        def package_url
          'http://download.slimerjs.org/releases/0.9.4/slimerjs-0.9.4-linux-i686.tar.bz2'
        end
      end
    end
    ...
    class OsX < Platform
      class << self
        ...
        def package_url
          'http://download.slimerjs.org/releases/0.9.4/slimerjs-0.9.4-mac.tar.bz2'
        end
      end
    end
    ...
    class Win32 < Platform
      class << self
        ...
        def package_url
          'http://download.slimerjs.org/releases/0.9.4/slimerjs-0.9.4-win32.zip'
        end
      end
    end
  end
